  ...
  return (
    ...
    <main>
      ...
      <section className="home_pub"> 
        <img src="../images/homepub/Pub_home.jpg" className="img_1" alt="cartão de sócio com referência à novidade pack familia e um menino vestido com fato de treino com emblema da udvc" />
        <img src="../images/homepub/Pub_home_Mob.jpg" className="img_2" alt="cartão de sócio com referência à novidade pack familia" />
